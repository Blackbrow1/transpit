<?php
$title = 'Безопасность на перроне | Транспит';
$keywords = 'обучение, уроки, сдо, система дистанционного обучения, онлайн курс, онлайн школа';
$description = 'Обучение Безопасность на перроне"';
$url = 'https://transpit-edu.ru/training-aircraft-safety';
...
include ROOT . 'templates/training/training-aircraft-safety.tpl';
