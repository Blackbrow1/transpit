<?php
$title = 'Система управления безопасностью полетов | Транспит';
$keywords = 'обучение, уроки, сдо, система дистанционного обучения, онлайн курс, онлайн школа';
$description = 'Обучение Система управления безопасностью полетов"';
$url = 'https://transpit-edu.ru/training-sms';
...
include ROOT . 'templates/training/training-sms.tpl';
