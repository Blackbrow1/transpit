<?php
$title = 'Описание теста "Система управления безопасностью полетов" | Транспит';
$keywords = 'тест';
$description = 'Описание теста "Система управления безопасностью полетов"';
$url = 'https://transpit-edu.ru/test-hero-sms';
...
include ROOT . 'templates/test-hero/test-hero-sms.tpl';
