            ...
            <div class="add-user__inputs">
              ...
              <div class="add-user__city add-user__city--post big-filter">
                <select class="big-filter__select add-user__select--post" name="post">
                  ...
                  <option value="Начальник службы CCT">Начальник службы CCT</option>
                  <option value="Начальник службы логистики">Начальник службы логистики</option>
                  ...
                  <option value="Главный механик">Главный механик</option>
                  <option value="Руководитель группы">Руководитель группы ССТ</option>
