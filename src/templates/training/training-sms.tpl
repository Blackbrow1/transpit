<main>
  ...
  <?php else: ?>
  <section id="training-sms" class="training">
    <div class="training__wrap">
      <h1 class="training__title">Система управления безопасностью полетов</h1>
      ...
      <a href="<?php echo HOST; ?>test-hero-sms<?php echo $urlWithToken; ?>"
