<main>
  ...
  <?php else: ?>
  <section id="training-rpo" class="training">
    <div class="training__wrap">
      <h1 class="training__title">РПО и правила маневрирования в зоне стоянки ВС</h1>
      ...
      <a href="<?php echo HOST; ?>test-hero-rpo<?php echo $urlWithToken; ?>"
