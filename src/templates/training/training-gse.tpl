<main>
  ...
  <?php else: ?>
  <section id="training-gse" class="training">
    <div class="training__wrap">
      <h1 class="training__title">Основы безопасности ПРР и использования средств Механизации</h1>
      ...
      <a href="<?php echo HOST; ?>test-hero-gse<?php echo $urlWithToken; ?>"
