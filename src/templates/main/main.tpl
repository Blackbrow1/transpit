  ...
  <section class="information">
    <div class="information__wrap">
      ...
      <div class="information__content">
        <p class="information__text">Система обучения создана с целью предоставления сотрудникам группы компаний
          "Транспит" актуальных знаний и информации. Обучение проходит как на рабочем месте, так и вне отрыва от
          работы.</p>
