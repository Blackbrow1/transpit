...
const humanFactorTrainingData = [
  {
    theme: 'Ошибки и нарушения',
    ...
    paragraph: [
      'Знаете ли вы?',
      'Когда речь идет о человеческом поведении на рабочем месте ваши знания мироощущения влияют на ваши действия, реакцию и решения.',
      'Ваша мотивация также влияет на вашу эффективность. Люди мотивируются различными вещами, такими например, как осознание того, что их работа привносит положительные изменения.',
      'Ваша мотивация, знания, умения и мироощущения вместе определяют ваше поведение на рабочем месте'
    ]
  },
  {
    theme: '',
    ...
    paragraph: [
      'Вы сделали ошибку из-за проблем с дизайном? Потянули вы на себя дверь тогда как ее нужно было толкнуть?',
      'Человеческий фактор и Эргономика – это наука о создании рабочей среды для человека. Иными словами наука о том, что среда, оборудование и задачи подходят для людей, назначенных выполнять ту или иную работу, с тем, чтоб работа была выполнена максимально эффективно.',
      'Человеческий Фактор может обеспечить вам безопасность и эффективность в выполнении вашей работы.',
      'Если причиной вашей ошибки стала проблема дизайна/конструкции – об этом обязательно нужно доложить!'
    ]
  },
  {
    theme: '',
    ...
    paragraph: [
      '<span class="unsuccess">Ошибки</span> происходят от действий или решений без намерения что-либо нарушить.',
      '<span class="unsuccess">Нарушения</span> происходят от действий и решений с намерением нарушить правила или процедуры.'
    ]
  },
  {
    theme: 'Ознакомьтесь с ситуациями и определите идет ли речь об ошибке или нарушении',
    ...
    paragraph: [
      '1. После обслуживания рейса Максим и Илья должны направиться в офис.',
      '2. Максим напоминает Илье, о необходимости  пристегнуть ремень безопасности.',
      '3. Илья сразу же его надевает.',
      'Данная ситуация является примером <span class="unsuccess">ОШИБКИ</span>'
    ]
  },
  {
    theme: 'Ознакомьтесь с ситуациями и определите идет ли речь об ошибке или нарушении',
    ...
    paragraph: [
      '1. После обслуживания рейса Максим и Илья должны направиться в офис.',
      '2. Максим напоминает Илье, о необходимости пристегнуть ремень безопасности.',
      '3. Илья ничего не предпринимает даже  после напоминания.',
      'Данная ситуация является примером <span class="unsuccess">НАРУШЕНИЯ</span>'
    ]
  },
  {
    theme: 'Нормы нагрузки, давление и стресс',
    ...
    paragraph: [
      'Человеческий Фактор позволяет изучить человеческое поведение и эффективность. Такие аспекты как люди, оборудование, процедуры и процессы влияют на ваше поведение и эффективность на рабочем месте.',
      'Ваши действия и реакция на эти факторы будут влиять на результат вашей работы и задач, которые вы призваны решать.',
      'Примером этого является то, как нормы, нагрузка, давление и стресс влияют на эффективность вашей работы.'
    ]
  },
  {
    theme: '',
    ...
    paragraph: [
      '<span class="main-color text-size-26">Что это значит?</span> Когда  более  простой  или  короткий способ  выполнить  ту  или  иную  задачу не получает негативного результата, его применение может быть продолжено и может превратиться в норму.',
      '<span class="main-color text-size-26">Что необходимо понимать?</span> Разницу  между  позитивной  “нормой”, которая  поддерживает  уровень безопасности,  такие  как  следование правилам,  процедурам  и  инструкциям  и негативной  “нормой”,  которая  не поддерживает  необходимый  уровень безопасности.'
    ]
  },
  {
    theme: '',
    ...
    paragraph: [
      'Негативные нормы – могут быть опасными.',
      'Вы обязаны следовать процедурам для того, чтоб обеспечить необходимый уровень безопасности.'
    ]
  },
  {
    theme: '',
    ...
    paragraph: [
      '<span class="main-color text-size-26">Что это значит?</span> Количество задач, которые вам необходимо решить за определенное время.',
      '<span class="main-color text-size-26">Что необходимо понимать?</span> Не следует решать слишком большое количество задач в то же самое определенное время.'
    ]
  },
  {
    theme: '',
    ...
    paragraph: [
      'Самый важный инструмент управления нагрузкой находится внутри вас. Это ваша способность мыслить. Вы способны сами определить, когда нагрузка запредельная и обратиться за помощью.',
      'Вот несколько советов по управлению вашей нагрузкой.',
      '1. Расставлять приоритеты в работе',
      '2. Справляться с внезапными проблемами',
      '3. Использовать Все ресурсы'
    ]
  },
  {
    theme: 'Расставлять приоритеты',
    ...
    paragraph: [
      'Когда есть много задач, требующих выполнения, очень важно определить самые важные.',
      'Задайте себе следующие вопросы, для того, чтоб определить какую задачу выполнить первой.',
      '1. Могу ли я пропустить эту задачу? (Нет)',
      '2. Могу ли я задержать выполнение этой задачи? (Нет)',
      '3. Могу ли я перепоручить выполнение этой задачи? (Нет)',
      'Вывод: Выполнить её <span class="success bold">СЕЙЧАС!</span>'
    ]
  },
  {
    theme: 'Справляться с внезапными проблемами',
    ...
    paragraph: [
      'Внезапно возникающие проблемы – это часть работы и их нельзя игнорировать или избегать. Но вот, что необходимо делать',
      '1. Остановите выполнение своей задачи.',
      '2. Займитесь выполнением внезапно возникшей проблемы, если работаете с людьми попросите их подождать.',
      '3. Оцените ситуацию, если необходимо вернитесь не несколько шагов назад в выполнении своей задачи, чтоб убедиться, что вы ничего не упустили.',
      '4. Продолжайте выполнение своей задачи.'
    ]
  },
  {
    theme: 'Используйте все ресурсы',
    ...
    paragraph: [
      'Вот некоторые ресурсы, которые помогут контролировать вашу нагрузку, вам необходимо определить когда их использование будет наиболее эффективным.',
      '1. Инструменты / оборудование. Подъёмник для погрузки негабаритных и тяжелых грузов',
      '2. Автоматизация. Коммуникаторы для связи и удаленного доступа',
      '3. Коллеги и руководитель. Коллеги и супервайзеры для помощи рекомендаций'
    ]
  },
  {
    theme: '',
    ...
    paragraph: [
      '<span class="main-color text-size-26">Что это значит?</span> Стресс – это натуральная реакция угрозам и опасностям на работе и в личной жизни.',
      'Стресс влияет на тело, разум – и как следствие работе. Это часть нашей жизни, но он увеличивает риск возникновения ошибок и губительно сказывается на здоровье человека.',
      '<span class="main-color text-size-26">Что необходимо понимать?</span> Как решать проблемы и выходить из ситуаций, приводящих к стрессу.'
    ]
  },
  {
    theme: '',
    ...
    paragraph: [
      'Когда сердце начинает чаще биться, вы потеете, чувствуете неуверенность и нервозность – все это может быть знаком того, что вы переживаете стресс.',
      'Вот несколько советов по управлению вашим стрессом.',
      '1. Попытайтесь решить проблему, из-за которой вы испытываете стресс.',
      '2. Попытайтесь принять ситуацию и найти способы управления ею.',
      '3. Обсудите со своим другом, коллегой или руководителем то, из-за чего вы испытываете стресс и особы помочь вам.'
    ]
  },
  {
    theme: '',
    ...
    paragraph: [
      '<span class="main-color text-size-26">Что это значит?</span> Что вы чувствуете, когда люди, окружающие вас (коллеги) говорят о том, что вам необходимо поспешить с выполнением своих задач.',
      'Что вы чувствуете, когда руководство напоминает вам, о необходимо выполнения своих задач в отведенный срок.',
      'Когда у вас меньше времени, чем необходимо для выполнения задачи.',
      '<span class="main-color text-size-26">Что необходимо понимать?</span> Когда вы подвергаетесь слишком большому давлению – это может привести к ошибкам.'
    ]
  },
  {
    theme: '',
    ...
    paragraph: [
      'Как и стресс, давление - часть повседневной жизни. Вы можете использовать следующие методы для управления давлением.',
      '1. Давление коллег.',
      '2. Давление руководства.',
      '3. Нехватка времени.'
    ]
  },
  {
    theme: 'Давление со стороны коллектива',
    ...
    paragraph: [
      'Не забывайте, что неправильно – всегда неправильно, даже если так делают все, и правильно – всегда правильно, даже если так не делает никто. Чтобы справиться с давлением со стороны коллектива:',
      '1. Посмотрите человеку в глаза.',
      '2. Говорите спокойно и ясно.',
      '3. Скажите, что не хотите сделать что-то неправильно.',
      '4. Поговорите о том, как действовать в данной ситуации согласно процедуре.',
      '5. Если собеседник не согласен, попросите помощи у коллеги или супервайзера.'
    ]
  },
  {
    theme: 'Давление со стороны руководства',
    ...
    paragraph: [
      'Чтобы справиться с давлением со стороны руководства:',
      '1. Убедитесь, что ваша задача вам полностью понятна.',
      '2. Если вы предполагаете, что есть какой-либо риск, сообщите об этом немедленно.',
      '3. Попросите о помощи когда она вам необходима.',
      '4. Когда у вас есть обратная cвязь/комментарий руководства, используйте его для того, чтоб сделать свою работу более  безопасной.'
    ]
  },
  {
    theme: 'Нехватка времени',
    ...
    paragraph: [
      'Для эффективного управления своим временем:',
      '1. Планируйте заранее.',
      '2. Составьте список важных дел.',
      '3. Остановитесь, подумайте и действуйте.',
      '4. Не спешите, спешка может привести к ошибкам.',
      '5. В точности следуйте процедурам!'
    ]
  },
  {
    theme: '',
    ...
    paragraph: [
      'Ознакомьтесь с ситуациями, представленными ниже и ответьте на вопросы.',
      '1. Водитель автолифта стыкует автолифт к самолету. Прилет  рейса был задержан на 30 минут.',
      '2. Он получил звонок от представителя авиакомпании с просьбой поспешить и далее звонок от начальника смены с иной информацией.',
      '3. Телефонные звонки отвлекли оператора и это привело к  инциденту.',
      'Каким способом оператор автолифта мог предотвратить инцидент? (Ответив на телефонный звонок только после того, как выполняемая задача завершена)',
      'Что привело к инциденту? (Нехватка времени и давление со стороны руководства)'
    ]
  },
  {
    theme: 'Усталость, алкоголь и наркотики',
    ...
    paragraph: [
      '<span class="main-color text-size-26">Что это значит?</span> Переутомление – это чувство усталости, сопровождающее вас постоянно.',
      '<span class="main-color text-size-26">Что необходимо понимать?</span> Риск переутомления высок при долгом рабочем дне, работе в ночные часы и недостаточной продолжительности сна.'
    ]
  },
  {
    theme: '',
    ...
    paragraph: [
      'Если вы чувствуете себя очень усталым, не беритесь за трудные задачи. Чтобы избежать переутомления, следует:',
      '1. Делать короткие перерывы.',
      '2. Придерживаться здорового питания.',
      '3. Избегать употребления кофе и энергетических напитков.',
      '4. Заниматься спортом и вести активный образ жизни.',
      '5. Стараться отводить достаточное количество времени на отдых, особенно после продолжительного рабочего дня.',
      'Компании группы TRANSPIT <span class="unsuccess">КАТЕГОРИЧЕСКИ НЕ ПРИЕМЛЮТ</span> употребление алкоголя и наркотических веществ.'
    ]
  },
  {
    theme: '',
    ...
    paragraph: [
      'Ознакомьтесь с ситуациями, представленными ниже и ответьте на вопросы.',
      '1. Экспедитор работал 3 ночных смены подряд.',
      '2. В течение дня после своих смен он заботится о своем заболевшем ребенке.',
      '3. В четвертую ночную смену он не может сконцентрироваться и совершает множество ошибок при обслуживании рейсов',
      'Экспедитор мог предотвратить сложившуюся ситуацию, сообщив... (Начальнику смены о своей личной проблеме и попросив время на отдых)',
      'Что привело к ошибкам? (Переутомление)'
    ]
  },
  {
    theme: 'Владение обстановкой',
    ...
    paragraph: [
      '<span class="main-color text-size-26">Что это значит?</span> Быть начеку и обращать внимание на угрозы безопасности рядом с собой.',
      '<span class="main-color text-size-26">Что необходимо понимать?</span> Рассеянность, стресс и недостаточность инструкций могут нарушить ваше владение обстановкой.'
    ]
  },
  {
    theme: 'Три шага, чтобы владеть обстановкой',
    ...
    paragraph: [
      '<span class="main-color text-size-26">Замечать.</span> Замечайте то, что происходит вокруг вас, будьте информированы.',
      '<span class="main-color text-size-26">Понимать.</span> Собирайте информацию, чтобы понимать ситуацию, в которой находитесь.',
      '<span class="main-color text-size-26">Думать наперед.</span> Думайте о том, что может произойти дальше и каковы будут ваши действия.'
    ]
  },
  {
    theme: 'Замечать',
    ...
    paragraph: [
      '- получать информацию',
      '- отмечать всю необходимую информацию',
      '- наблюдать',
      '- контролировать'
    ]
  },
  {
    ...
    paragraph: [
      ...
      '- представлять полную картину действий',
      '- знать, что происходит в данный момент'
    ]
  },
  {
    theme: 'Думать наперед',
    ...
    paragraph: [
      '- знать, что будет происходить дальше',
      '- планировать  следующие действия',
      '- предвосхищать грядущие события'
    ]
  },
  {
    theme: 'Коммуникация и взаимодействие',
    ...
    paragraph: [
      '<span class="main-color text-size-26">Что это значит?</span> Говорить, слушать, писать, читать',
      '<span class="main-color text-size-26">Что необходимо понимать?</span> Сложности коммуникации:',
      '- шум',
      '- эмоции',
      '- отвлекающие факторы',
      '- языковые различия',
      '- плохое умение слушать',
      '- ошибки в понимании'
    ]
  },
  {
    ...
    paragraph: [
      'Ваш разговор с собеседником должен быть:',
      '1. Ясным – используйте простые слова.',
      '2. Структурированным – разговор должен иметь четкое начало и завершение.',
      '3. Коротким – используйте простые предложения.',
      '4. Корректным – используйте корректные слова.'
    ]
  },
  {
    theme: '',
    ...
    paragraph: [
      '<span class="main-color text-size-26">Что это значит?</span> Работать вместе со своей командой для достижения общей цели',
      '<span class="main-color text-size-26">Что необходимо понимать?</span> Мешает взаимодействию:',
      '- неясные цели',
      '- нечетко определенные роли',
      '- нехватка доверия',
  ...
  {
    theme: 'Приемы для эффективной работы в команде',
    ...
    paragraph: [
      'Обсудите, каким образом задача должна быть выполнена.',
      'Убедитесь, что все участники поняли и согласились.',
      'Доверяйте членам вашей команды.'
    ]
  }
];
...
const rpoTrainingData = [
  {
    ...
    paragraph: [
      ...
      'Данный обучающий материал носит профилактический характер и направлен на освежение знаний экспедиторского состава ТСЗ о правилах и требованиях предъявляемых к руководителю ПО во время ПО. И необходимых для минимизации возможных происшествий связанных с его деятельность.',
      'Используется в качестве повторного обучения всего экспедиторского состава ТСЗ, с последующей проверкой знаний, в виде тестирования. Сотрудники не прошедшие обучение или не сдавшие тестовую часть, к самостоятельной работе не допускаются.'
    ]
  },
  {
    theme: 'Вождение',
    ...
    paragraph: [
      ...
      '2. Запрещено пользоваться мобильным телефоном при подъезде/отъезде к/от ВС или слушать радио (при необходимости остановитесь в безопасном месте).',
      '3. Внутри ТС нельзя есть, пить, курить.',
      '4. Следуйте вдоль белых линий разметки (желтые линии предназначены для самолётов).',
      '5. Запрещено перевозить посторонних пассажиров.',
      '6. Преимущество в движении всегда у ВС, пешеходов и автомобилей экстренных служб.',
      '7. Всегда пристегивайтесь ремнем безопасности.',
      '8. Ехать можно только сидя.',
      '9. Будьте внимательны за рулем.'
    ]
  },
  {
    ...
    paragraph: [
      ...
      'При обнаружении посторонних предметов поднимите и уберите их, если это безопасно, если нет немедленно проинформируйте сменного начальника службы доставки и работника отдела БОВС.'
    ]
  },
  {
    theme: '',
    ...
    paragraph: [
      ...
      'Для обеспечения безопасности (своей и/или окружающих) необходимо:',
      '- Всегда быть внимательным и следить за тем, что происходит вокруг;',
      '- Не ходить под воздушным судном;',
      '- Не переезжать топливный шланг или кабели заземления;',
      '- Избегать скольжений и падений;',
      '- Обходить разливы жидкостей и немедленно докладывать о них сменному начальнику службы доставки и работникам отдела БОВС.'
    ]
  },
  {
    ...
    paragraph: [
      ...
      '2. Движущиеся транспортные средства, оборудование;',
      '3. Погодные условия и экстремальные температуры;',
      '4. Выполнение работ в ночное время;',
      '5. Выполнение работ на высоте.'
    ]
  },
  {
    ...
    paragraph: [
      ...
      '2. Шум, дым, разливы жидкостей;',
      '3. Воздухазабор двигателя, выхлопы, струя реактивного двигателя.'
    ]
  },
  {
    ...
    paragraph: [
      ...
      '- Будьте особенно внимательны, учитывая увеличенный тормозной путь и скользкую дорожную поверхность.',
      '- Никогда не загружайте воздушное судно во время противообледенительных работ – реагенты могут быть токсичны. (При контакте с ними срочно обратитесь в медпункт).',
      '- На автолифтах запрещено проводить погрузочно-разгрузочные работы, если скорость ветра превышает 72 км/ч (40 узлов).',
      '- Необходимо соблюдать достаточное расстояние между автолифтом и воздушным судном.',
      '- На платформе автолифта не должны находиться какие-либо предметы превышающие по высоте защитное ограждение. Нельзя перевозить незакрепленные предметы на крыше тележки. Можно толкать только 1 тележку за 1 раз, это нужно делать двумя руками.'
    ]
  },
  {
    ...
    paragraph: [
      ...
      '- Потенциальная опасность исходит от двигателей и винтов: воздухозабор и струя реактивного двигателя.',
      '- Объекты могут оказаться затянутыми внутрь двигателя. Зоны выхлопов за двигателями состоят из горячих выхлопных газов и воздуха, посторонние предметы, попавшие в выхлопную струю, могут вылетать с очень большой скоростью. Винты воздушного судна могут привести к серьезным повреждениям и авариям, независимо от того вращаются они или нет.'
    ]
  },
  {
    ...
    paragraph: [
      ...
      'Дайте дорогу воздушному судну, находящемуся на рулении, перед тем как пересекать его путь.',
      '<span class="unsuccess">Никогда</span> не приближайтесь к воздушному судну до полной остановки двигателей (следите за вращением).'
    ]
  },
  {
    theme: '',
  ...
  },
  {
    ...
    paragraph: [
      ...
      '- Строго следуйте сигналам руководителя подъездом/отъездом к/от ВС.',
      '- Следите за тем, что происходит вокруг вас.',
      'Вождение внутри круга безопасности требует особого внимания. Никогда не перемещайте оборудование не принадлежащее ООО «Транспит Северо-Запад» (технические стремянки, тележки для багажа и груза и тд.) В случаях, если перечисленное оборудование препятствует подъезду/отъезду автолифта к/от ВС, проинформируйте сменного начальника службы доставки и сотрудника отдела БОВС, ожидайте пока не уберут оборудование препятствующее подъезду/отъезду автолифта к/от ВС.'
    ]
  },
  {
    ...
    paragraph: [
      ...
      '<span class="unsuccess">При потере визуального контакта между водителем и руководителем подъездом/отъездом к/от ВС, водитель обязан остановиться, продолжать движение можно только при возобновлении визуального контакта.</span>'
    ]
  },
  {
  ...
  },
  {
    ...
    paragraph: [
      ...
      'Движение должно замедляться по мере приближения к планируемому пункту назначения.'
    ]
  },
  {
    theme: 'Сигналы руками',
  ...
  },
  {
    ...
    paragraph: [
      ...
      '3. Руководитель подъездом, отъездом занимает положение у средней части крыла.'
    ]
  },
  {
    theme: 'Подъезд к воздушному судну',
  ...
  },
  {
    ...
    paragraph: [
      ...
      '9. Руководитель подъездом/отъездом устанавливает упорные колодки, водитель устанавливает автолифт на стабилизаторы (опоры).'
    ]
  },
  {
    theme: '',
    ...
    paragraph: [
      ...
      '- Всегда стойте ровно и направляйте автолифт к себе;',
      '- Помните об оборудовании, багаже и людях, с которыми вы можете столкнуться и упасть;',
      '- При необходимости изменения маршрута автолифта, остановите транспортное средство и поменяйте свое местоположение, только после этого подайте команду водителю на возобновление движения.'
    ]
  },
  {
    ...
    paragraph: [
      ...
      '- До начала подъема кузова автолифта необходимо убедиться, что двери воздушного судна закрыты;',
      '- Открытая дверь воздушного судна создает риск падения из нее персонала, находящегося на ВС, и увеличивает риски повреждения ВС;',
      '- До начала подъема/опускания кузова автолифта необходимо проверить пространство под и над автолифтом на предмет наличия людей или оборудования.'
    ]
  },
  {
  ...
  },
  {
    ...
    paragraph: [
      ...
      'До момента подачи сигнала на открытие дверей воздушного судна необходимо осмотреть фюзеляж в районе створа двери на предмет повреждений.'
    ]
  },
  {
    theme: 'Действия в чрезвычайных ситуациях',
    ...
    paragraph: [
      ...
      'В случаях обнаружения повреждений фюзеляжа ВС в районе створа двери, до момента подачи сигнала на открытие двери ВС, немедленно прекратите все работы и проинформируйте о выявленных повреждениях инженера АК, представителя авиакомпании, сменного начальника службы доставки, работника отдела БОВС.'
    ]
  },
  {
    theme: 'Действия в чрезвычайных ситуациях',
    ...
    paragraph: [
      ...
      '2. Оставайтесь с получившим травму работником до прибытия экстренных служб.',
      '3. Возьмите контактные данные у свидетелей происшествия.',
      '4. Дождитесь прибытия на место происшествия  Вашего руководства.',
      'О всех происшествиях с персоналом необходимо докладывать руководству!',
      'Не перемещайте транспортное средство без особых инструкций инспектора по безопасности или сотрудников авиакомпании.',
      '<span class="unsuccess bold">НЕМЕДЛЕННО СООБЩИТЕ О ПРОИСШЕСТВИИ:</span>',
      '- Сменному начальнику службы логистики ООО «Транспит Северо-Запад»'
    ]
  },
  {
    theme: 'Действия в чрезвычайных ситуациях',
    ...
    paragraph: [
      ...
      '2. Составьте карту схему (расположение оборудования и других транспортных средств, персонала).',
      '3. Возьмите контактные данные у свидетелей происшествия.',
      '4. Дождитесь прибытия на место происшествия ответственного работника отдела БОВС и Вашего руководства.',
      'Необходимо докладывать о всех происшествиях с воздушными судами',
      'Не перемещайте транспортное средство без особых инструкций администрации или сотрудников авиакомпании.',
      '<span class="unsuccess bold">НЕМЕДЛЕННО СООБЩИТЕ О ПРОИСШЕСТВИИ:</span>',
      '- Сотруднику СПО ВВСС (супервайзер обслуживающий рейс)',
      '- Сменному начальнику службы логистики ООО «Транспит Северо-Запад»'
    ]
  },
  {
    ...
    paragraph: [
      ...
      '3. Возьмите контактные данные у свидетелей происшествия.',
      '4. Дождитесь прибытия на место происшествия Вашего руководства.',
      'Необходимо докладывать о всех происшествиях с транспортными средствами ДТП.',
      'Не перемещайте транспортное средство без команды администрации аэропорта или сотрудников авиакомпании.',
      '<span class="unsuccess bold">НЕМЕДЛЕННО СООБЩИТЕ О ПРОИСШЕСТВИИ:</span>',
      '- Экстренным службам, скорой помощи',
      '- Сменному начальнику службы логистики ООО «Транспит Северо-Запад»'
    ]
  }
];
...
const gseTrainingData = [
  {
    ...
    paragraph: [
      ...
      'Самыми сильными источниками опасности в ПРР являются неосторожность и излишняя уверенность персонала, задействованного в наземном обслуживании ВС. Осознано следуя представленным в данном приложении Процедурам безопасности ПРР Вы обеспечите не только Вашу собственную безопасность, но и безопасность окружающих, а также снизите риск повреждения воздушного судна и других инцидентов.',
      'Запомните: Безопасность - это ответственность каждого.'
    ]
  },
  {
    theme: '',
    ...
    paragraph: [
      ...
      '2. Потенциальные угрозы. Незапланированное или непредсказуемое событие, которое могло привести, но не привело к травмам или повреждению собственности.',
      '3. Факторы риска. Потенциальные факторы риска причинения вреда, нанесения травм или повреждений.',
      'Всегда сообщайте об авариях, происшествиях и источниках опасности.',
      'Для постоянного совершенствования уровня безопасности необходимо всегда сообщать обо всех авариях, нештатных и опасных ситуациях ответственным лицам.'
    ]
  },
  {
    theme: 'Подготовка',
    ...
    paragraph: [
      ...
      'Ваша униформа и средства индивидуальной защиты, защищают Вас от источников опасности на производстве, которые могут привести к травмам.',
      'Вы обязаны убедиться, что у Вас есть необходимая и пригодная к использованию униформа и средства индивидуальной защиты. Необходимо незамедлительно сообщать ответственным лицам обо всех повреждениях или утерянных деталях униформы и /или средств индивидуальной защиты.',
      'Яркая униформа и средства индивидуальной защиты делают Вас хорошо заметным для окружающих.',
      'Защитные перчатки защищают Ваши руки от порезов, ожогов, заноз, низкой и высокой температуры.',
      'Спецобувь надежна и защищает Вас от падающих предметов, сдавливания и проколов, порезов стопы.'
    ]
  },
  {
    theme: 'Подготовка',
    ...
    paragraph: [
      ...
      '2. Обязанностью водителя является проверка  транспортного средства с применением утвержденной в ООО «Транспит Северо-Запад» формы проверки ТС перед поездкой.',
      '3. Также необходимо помнить - Использование транспортных средств с серьезными неисправностями должно быть немедленно прекращено, возобновление эксплуатации возможно только после полного устранения неисправностей.',
      '4. Эта процедура обязательна. Неиспользование данной процедуры потенциально подвергает риску других лиц на дороге.',
      'Обо всех повреждениях транспортных средств необходимо сообщать ответственным лицам.',
      'Все транспортные средства должны быть исправны.'
    ]
  },
  {
    theme: 'Кейтеринг',
    ...
    paragraph: [
      ...
      '- БКО – тележки и контейнеры с продуктами питания, товарно-материальными ценностями, хрупким оборудованием постоянно перемещаются.',
      '- Внимательность и соблюдение представленных инструкций минимизирует риск получения травм и повреждения оборудования.'
    ]
  },
  {
    theme: 'Кейтеринг',
    ...
    paragraph: [
      ...
      'При перемещении тележки на ее поверхности (внутри окантовки) можно размещать только один контейнер и ни одного при неблагоприятных условиях (сильный ветер, сырость, гололед и т.д.).'
    ]
  },
  {
  ...
  },
  {
    ...
    paragraph: [
      ...
      '3. Правильное положение тела важно при подъеме веса и при перемещении груза.'
    ]
  },
  {
    theme: 'Вблизи ВС',
  ...
  },
  {
    ...
    paragraph: [
      ...
      'Никогда не подвергайте себя опасности, если расстояние между передней площадкой автолифта и фюзеляжем воздушного судна слишком большое, возникает риск падения с высоты, в этом случае необходимо   прекратить все работы и изменить положение автолифта.'
    ]
  },
  {
  ...
  },
  {
    ...
    paragraph: [
      ...
      '<span class="unsuccess">ВАЖНО:</span>  Погрузка/разгрузка телег с бортовым питанием/БКО на контактных стоянках по технической лестнице телескопического трапа <span class="unsuccess">ЗАПРЕЩЕНА.</span>'
    ]
  },
  {
  ...
  },
  {
    ...
    paragraph: [
      'Открытие/закрытие дверей воздушного судна производится в соответствии с требования и правилами установленными в ООО «Транспит Северо-Запад», с целью исключения повреждения воздушного судна никогда не открывайте и не закрывайте дверь ВС самостоятельно, открывать и закрывать двери ВС может только работник авиакомпании имеющий разрешение на выполнение этих операций.',
      'В случае срабатывания аварийного трапа примите все меры направленные на исключение получения травм и повреждения оборудования. Немедленно проинформируйте сменного начальника службы доставки и работника отдела БОВС о происшествии.',
      'В случаях обнаружения повреждений фюзеляжа ВС в районе створа двери, до момента подачи сигнала на открытие двери ВС, немедленно прекратите все работы и проинформируйте о выявленных повреждениях инженера АК, представителя АК и сменного начальника службы доставки.'
    ]
  }
];
