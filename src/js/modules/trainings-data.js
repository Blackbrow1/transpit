...
const rpoTrainingData = [
  ...
  },
  {
    ...
    imgWebp2: 'img/trainings/human-factor/img-3-desktop@2x.webp',
    paragraph: [
      'Посторонние предметы – это мусор или забытые предметы, которые потенциально могут причинить вред. Пример: при попадании в двигатель посторонние предметы могут нанести серьезные повреждения или стать причиной возгорания двигателя. Переносимые струей реактивного двигателя, посторонние предметы могут ранить персонал или повредить наземное оборудование.',
  ...
  },
  {
    ...
    imgWebp2: 'img/trainings/human-factor/img-8-desktop@2x.webp',
    paragraph: [
      'Когда безопасно приближаться к воздушному судну?',
  ...
  },
  {
    ...
    paragraph: [
      ...
      'Никогда не приближайтесь к воздушному судну до полной остановки двигателей (следите за вращением).'
    ]
  },
  {
    theme: '',
    ...
    imgWebp2: 'img/trainings/human-factor/img-10-desktop@2x.webp',
    paragraph: [
      'Никогда не приближайтесь к воздушному судну до отключения проблесковых огней предупреждения столкновений'
    ]
  },
  {
    theme: '',
    ...
    imgWebp2: 'img/trainings/human-factor/img-11-desktop@2x.webp',
    paragraph: [
      'Никогда не приближайтесь к воздушному судну до блокировки шасси (установка упорных колодок под колеса ВС)'
    ]
  },
  {
    theme: '',
  ...
  },
  {
    ...
    imgWebp2: 'img/trainings/human-factor/img-13-desktop@2x.webp',
    paragraph: [
      'Круг безопасности (зона обслуживания ВС) – это условная граница вокруг воздушного судна, составляющая около 5 метров от конечных точек воздушного судна. При нахождении внутри круга безопасности…',
