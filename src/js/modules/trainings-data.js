...
const humanFactorTrainingData = [
  ...
  },
  {
    ...
    paragraph: [
      'Ошибки происходят от действий или решений без намерения что-либо нарушить.',
      'Нарушения происходят от действий и решений с намерением нарушить правила или процедуры.'
    ]
  },
  {
    ...
    paragraph: [
      ...
      'Данная ситуация является примером ОШИБКИ'
    ]
  },
  {
    theme: 'Ознакомьтесь с ситуациями и определите идет ли речь об ошибке или нарушении',
    ...
    paragraph: [
      ...
      'Данная ситуация является примером НАРУШЕНИЯ'
    ]
  },
  {
  ...
  },
  {
    ...
    paragraph: [
      'Что это значит? Когда  более  простой  или  короткий способ  выполнить  ту  или  иную  задачу не получает негативного результата, его применение может быть продолжено и может превратиться в норму.',
      'Что необходимо понимать? Разницу  между  позитивной  “нормой”, которая  поддерживает  уровень безопасности,  такие  как  следование правилам,  процедурам  и  инструкциям  и негативной  “нормой”,  которая  не поддерживает  необходимый  уровень безопасности.'
    ]
  },
  {
    theme: '',
  ...
  },
  {
    ...
    paragraph: [
      'Что это значит? Количество задач, которые вам необходимо решить за определенное время.',
      'Что необходимо понимать? Не следует решать слишком большое количество задач в то же самое определенное время.'
    ]
  },
  {
    theme: '',
  ...
  },
  {
    ...
    paragraph: [
      'Стресс  –  это  натуральная  реакция угрозам  и  опасностям  на  работе  и  в личной жизни.',
      ...
      'Необходимо знать как решать проблемы и выходить из ситуаций, приводящих к стрессу.'
    ]
  },
  {
    theme: '',
  ...
  },
  {
    ...
    paragraph: [
      'Что вы чувствуете, когда люди, окружающие вас (коллеги) говорят о том, что вам необходимо поспешить с выполнением своих задач.',
      ...
      'Что необходимо понимать? Когда  вы  подвергаетесь  слишком большому  давлению  –  это  может привести к ошибкам.'
    ]
  },
  {
    theme: '',
  ...
  },
  {
    ...
    paragraph: [
      'Что это значит? Переутомление – это чувство усталости, сопровождающее вас постоянно.',
      'Что необходимо понимать? Риск переутомления высок при долгом рабочем дне, работе в ночные часы и недостаточной продолжительности сна.'
    ]
  },
  {
    theme: '',
    ...
    paragraph: [
      ...
      'Компании группы TRANSPIT КАТЕГОРИЧЕСКИ НЕ ПРИЕМЛЮТ употребление алкоголя и наркотических веществ.'
    ]
  },
  {
    theme: '',
  ...
  },
  {
    ...
    paragraph: [
      'Что это значит? Быть начеку и обращать внимание на угрозы безопасности рядом с собой.',
      'Что необходимо понимать? Рассеянность, стресс и недостаточность инструкций могут нарушить ваше владение обстановкой.'
    ]
  },
  {
    ...
    paragraph: [
      'Замечать. Замечайте то, что происходит вокруг вас, будьте информированы.',
      'Понимать. Собирайте информацию, чтобы понимать ситуацию, в которой находитесь.',
      'Думать наперед. Думайте о том, что может произойти дальше и каковы будут ваши действия.'
    ]
  },
  {
    theme: 'Замечать',
  ...
  },
  {
    ...
    paragraph: [
      'Что это значит? Говорить, слушать, писать, читать',
      'Что необходимо понимать? Сложности коммуникации:',
      '- шум',
      '- эмоции',
      '- отвлекающие факторы',
      '- языковые различия',
  ...
  },
  {
    ...
    paragraph: [
      'Что это значит? Работать вместе со своей командой для достижения общей цели',
      'Что необходимо понимать? Мешает взаимодействию:',
      '- неясные цели',
...
export {securityTrainingData, humanFactorTrainingData}
